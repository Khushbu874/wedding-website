...
const BoardingPass = () => {
  ...
  return (
    <section id="boarding-pass" className="section-padding" style={{ backgroundColor: 'var(--c-soft-black)' }}>
      <div className="container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <motion.h2 
          ...
          style={{ fontSize: '40px', marginBottom: '20px', letterSpacing: '4px' }}
        >
          {t('bp_title')}
        </motion.h2>
        
        <p className="font-secondary text-center" style={{ color: '#cccccc', marginBottom: '40px', fontSize: '18px' }}>
          {t('bp_subtitle')}
        </p>

        {!generated ? (
          <form onSubmit={handleGenerate} style={{ display: 'flex', gap: '10px', width: '100%', maxWidth: '400px' }}>
            <input 
              type="text" 
